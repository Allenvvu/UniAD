...
def transform_points_to_ego(
    ...
    # Z-coordinate normalization constants for semantic map data
    # Based on HCT logistic semantic map Z range: [40.785, 50.510]
    SEMANTIC_MAP_Z_MEAN = 43.92  # Mean elevation of semantic map
    ...
    for world_point in points:
        ...
        # Normalize Z coordinate: translate to center around ego origin
        ego_local_z = world_z - SEMANTIC_MAP_Z_MEAN
...
def transform_points_to_world(
    ...
    # Z-coordinate normalization constants (same as in transform_points_to_ego)
    SEMANTIC_MAP_Z_MEAN = 43.92
    ...
    for ego_point in ego_points:
        ...
        # Inverse Z normalization: restore original semantic map elevation
        world_z = ego_local_z + SEMANTIC_MAP_Z_MEAN
