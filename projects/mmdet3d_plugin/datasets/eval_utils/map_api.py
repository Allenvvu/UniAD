...
class NuScenesMapExplorer:
    ...
    def __init__(self,
        ...
        self.canvas_max_x = self.map_api.canvas_edge[2]
        self.canvas_min_x = self.map_api.canvas_edge[0]
        self.canvas_max_y = self.map_api.canvas_edge[3]
        self.canvas_min_y = self.map_api.canvas_edge[1]
