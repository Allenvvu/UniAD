#!/usr/bin/env python3
"""
Script to fix data_path in all .pkl files in data/infos directory.
...
def main():
    ...
    infos_dir = "/home/bryan/Desktop/Allen/uniad_inf/data/infos"
    ...
    # Find all .pkl files in data/infos directory
    pickle_pattern = os.path.join(infos_dir, "*.pkl")
    pickle_files = glob.glob(pickle_pattern)

    if not pickle_files:
        print(f"No .pkl files found in {infos_dir}")
        return
